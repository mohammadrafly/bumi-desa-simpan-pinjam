                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <table class="invoice">
                                            <tbody><tr>
                                                <td>ID <?= $pages ?> <?php echo $content['id_pembayaran']; ?><br><?php echo $content['created_at']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    <td class="content-block">
                                        <a href="<?= base_url('dashboard/transaksi/pembayaran/pdf/'.$content['id_pembayaran']); ?>">Print</a>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
