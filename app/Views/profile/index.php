            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" method="POST" action="<?= base_url('ProfileController/updatePassword'); ?>" enctype="multipart/form-data">
                  <?= csrf_field() ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="password" class="form-control" name="new_password_conf" placeholder="Konfirmasi Password Baru"/>
                          </div>
                        </div>
                      </div>
                    </div>
